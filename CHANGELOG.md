...
- ff9bb83: Right-clicking a cell inside a multi-cell table selection no longer collapses that selection.
- ff9bb83: Prevent extra CSS declarations from being rendered from editor content.
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
  - @tiptap/core@3.31.4
...
- ff9bb83: Prevent extra CSS declarations from being rendered from editor content.
- ff9bb83: Atom block directives (`:::name {…} :::`) indented by up to 3 spaces are now tokenized, matching CommonMark indentation rules for block constructs.
- ff9bb83: Bind `parseMarkdown` and `renderMarkdown` to the configured extension so hooks can read `this.options` and `this.name` without an Editor.
- ff9bb83: Stop joinItemForward and joinItemBackward from joining across isolating nodes.
- @tiptap/pm@3.31.4
...
- ff9bb83: Typing spaces after a link no longer extends the link, including multiple spaces inserted in one transaction. Formatting changes and undo/redo preserve existing linked whitespace.
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
...
- ff9bb83: Fix Enter and Shift-Enter inside React node views on iOS and Android.
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
- Updated dependencies [ff9bb83]
